...
st.markdown("""
    ...
    /* === SCREEN-WIDE NON-POPPING BACKGROUND BUBBLES === */
    .bubble-bg {
        position: fixed;
        width: 100vw; height: 100vh;
        top: 0; left: 0;
        z-index: 0; /* Stays completely behind all link cards */
        pointer-events: none; /* Allows mouse clicks to ignore them entirely */
    }
    .bubble {
        position: absolute;
        bottom: -60px;
    ...
    /* === CARTOON CARD LAYOUT WITH SPRING ENGINE === */
    .section-tag {
        font-family: 'Arial Black', Gadget, sans-serif;
        font-size: 0.9rem;
        font-weight: 900;
    ...
    /* Spring bounce forward and clockwise rotation */
    .link-card:hover {
    ...
    /* Icon turns in opposite counter-clockwise direction on hover */
    ...
    <!-- Continuous Screen-Wide Background Bubble Canvas Layer -->
    <div class="bubble-bg">
        <div class="bubble" style="left: 7%; width: 45px; height: 45px; animation-delay: 0s; animation-duration: 6s;"></div>
        <div class="bubble" style="left: 24%; width: 25px; height: 25px; animation-delay: 1.5s; animation-duration: 8s;"></div>
        <div class="bubble" style="left: 46%; width: 55px; height: 55px; animation-delay: 0.5s; animation-duration: 5s;"></div>
        <div class="bubble" style="left: 65%; width: 35px; height: 35px; animation-delay: 3s; animation-duration: 7s;"></div>
        <div class="bubble" style="left: 86%; width: 42px; height: 42px; animation-delay: 1s; animation-duration: 6.5s;"></div>
    </div>
...
# Main Static Presentational Header Panel
st.markdown(f"""
    <div class="game-zone">
